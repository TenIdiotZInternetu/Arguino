...
\begin{enumerate}
    \item Run \texttt{preprocess.sh} from the repository's root directory with the sketch directory as an argument. On Windows, use the \texttt{preprocess.bat} script instead. For example:
