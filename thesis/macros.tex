...
\newcommand\YAMLcolonstyle{\color{black}\mdseries\footnotesize}
\newcommand\YAMLkeystyle{\color{black}\mdseries\footnotesize}
\newcommand\YAMLvaluestyle{\color{brown}\bfseries\footnotesize}
...
\definecolor{slineno}{RGB}{131,148,150}
\definecolor{ssymbol}{RGB}{44,55,58}
\definecolor{scomment}{RGB}{13, 97, 4}
\definecolor{base2}{RGB}{238,232,213}
\definecolor{skeyword}{RGB}{24, 78, 143}
\definecolor{sident}{RGB}{8, 143, 161}
\definecolor{sstring}{RGB}{94, 130, 31}
...
\expandafter{\language@csharp}
{
  ...
  % numbersep=5pt,
  % firstnumber=auto,
  % numberstyle=\tiny\ttfamily\color{slineno},
  rulecolor=\color{base2},
  basicstyle=\footnotesize\ttfamily,
  commentstyle=\color{scomment},
  morecomment=[s][\color{scomment}]{/*+}{*/},
  morecomment=[s][\color{scomment}]{/*-}{*/},
