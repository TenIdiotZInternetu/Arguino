...
\definecolor{sarg}{RGB}{0, 117, 163}
...
\definecolor{sstring}{RGB}{207, 106, 19}
\definecolor{sctrl}{RGB}{4, 44, 112}
\definecolor{sattr}{RGB}{0, 117, 163}

\makeatletter

\newcommand\language@xaml{xaml}

\expandafter\expandafter\expandafter\lstdefinelanguage
\expandafter{\language@xaml}
{
  stringstyle=\color{sstring},
  morestring=[b]",
  moredelim=*[s][\bfseries\color{sctrl}]{<}{\ },
  moredelim=[is][\color{sattr}]{$}{$},
}
