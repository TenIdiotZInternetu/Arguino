...
\include{ch0_intro}
\include{ch1_arduino}
\include{ch2_architecture}
\include{ch3_backend_implementation}
\include{ch4_frontend_implementation}
\include{ch5_developer_docs}
...
The file attachment \texttt{thesis.zip} contains the repository with the source code in its entirety. The repository is equivalent with the public git repository found at the URL \url{https://github.com/TenIdiotZInternetu/Arguino} as of tag \texttt{v0.2.0\_Bc}.
